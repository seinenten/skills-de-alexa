...
const languageFacts = {
    "javascript":[
        "Es un lenguaje usado principalmente para desarollo web",
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola, puedo darte datos curiosos de algun lenguaje de programacion, di algo como "prueba javascript" ';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Puedo darte datos curiosos de algun lenguaje de programacion, di algo como "prueba javascript"';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Que las buenas practicas se vayan contigo!';
